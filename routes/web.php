...
Route::group(['prefix'=>'account'],function(){
    ...
    Route::group(['middleware'=>'auth'],function(){
        ...
        Route::post('profile/update', [ProfileController::class, 'updateProfile'])->name('account.updateProfile');

        Route::post('update-Password', [ProfileController::class, 'updatePassword'])->name('account.updatePassword');
...
Route::group(['prefix'=>'technician'],function(){
    ...
    Route::group(['middleware'=>'technician.auth'],function(){
        ...
        Route::get('logout',[TechnicianLoginController::class,'logout'])->name('technician.logout');
        ...
        Route::get('report/detail', [TechnicianReportController::class, 'detail'])->name('technician.reportDetail');
        Route::get('report/status', [TechnicianReportController::class, 'status'])->name('technician.reportStatus');
        Route::post('report/status', [TechnicianReportController::class, 'submitReport'])->name('technician.submitReport');
