<aside class="col-md-3 col-lg-2 d-md-block bg-light sidebar">
    ...
    <div class="sidebar">
      ...
      <a href="<?php echo e(route('technician.profile')); ?>" id="profile-link"><i class="fa fa-fw fa-user"></i> My Profile</a>
      <a href="<?php echo e(route('technician.editProfile')); ?>" id="profile-link"><i class="fa fa-fw fa-edit"></i> Edit Profile</a>
      <a href="<?php echo e(route('technician.changePassword')); ?>" id="profile-link"><i class="fa fa-fw fa-wrench"></i> Change Password</a>
      ...
      <a href="<?php echo e(route('technician.manageReport')); ?>" id="profile-link"><i class="fa fa-fw fa-plus"></i> Manage Report</a>
    </div>

    </body>
    </html>
    </aside>
<?php /**PATH C:\xampp\htdocs\fypproject\resources\views/technician/sidebar.blade.php ENDPATH**/ ?>