                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-center">
                                                <a href="<?php echo e(route('account.register')); ?>" class="link-secondary text-decoration-none">Create new account</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<?php /**PATH C:\xampp\htdocs\fypproject\resources\views/login.blade.php ENDPATH**/ ?>